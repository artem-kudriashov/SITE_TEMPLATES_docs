...
You can initialize, build, and deploy templates with the command line. Find a detailed guide for their usage in the [**Quickstart**](quickstart-guide-to-a-working-site-theme.md).
